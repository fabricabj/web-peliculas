...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2020 a las 13:48:12
...
(37, 'Capitan America: Civil War', ' accion SCI-FI Aventura', '147', 'La participaciÃ³n polÃ­tica en los asuntos de los Vengadores causa una brecha entre el CapitÃ¡n AmÃ©rica y Iron Man', 7.8, 'https://m.media-amazon.com/images/M/MV5BMjQ0MTgyNjAxMV5BMl5BanBnXkFtZTgwNjUzMDkyODE@._V1_UY190_CR0,0,128,190_AL_.jpg', 2016, ''),
...
--
ALTER TABLE `deletepeliculas`
  MODIFY `id_pelicula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
