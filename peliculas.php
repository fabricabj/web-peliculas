            ...
            <nav class="navbar navbar-expand-lg">
                                ...
                                <?php if($idgrupo==1){?>
                                 ...
                                 <li class="nav-item" style="margin:3px">
                                     <form method="POST" action="listado.php">
                                        <button  class="btn btn-dark" style="margin-top: 3%;width: 100%;" name="listado" value="listado">Listar peliculas</button>
                                     </form>
                                 </li>
                                <?php }
                             ?>
               ...
               <?php if (isset($_GET['pagina'])) {
                    ...
                    while ($r = mysqli_fetch_array($consulta2)) { ?>
                        <div align="center" class="col-md-3" style="padding:1%;">
                            <div class="card" style="width: 12.5rem;background:#212121;color:white">
                                ...
                                <?php if (isset($_SESSION['login']) && $_SESSION['login'] > 0) { ?>
                                    ...
                                    <a class="btn btn-dark" href="#" data-toggle="modal" data-target="#trailer<?php echo $r['id_pelicula'];?>"><i class="fas fa-video"></i> ver trailer</a>
                                <?php } else { ?>
                        ...
                        <div  data-backdrop="static"  class="modal" id="trailer<?php echo $r['id_pelicula']; ?>">
                            ...
                            <div class="modal-content">
                               ...
                               <div class="modal-body" style="background:#121212;color:white">
                                <div class="embed-container">
                                    <?php $traertrailer=mysqli_query($conexion,"SELECT trailer FROM movies WHERE id_pelicula='{$r['id_pelicula']}'");
                                    while($rs=mysqli_fetch_array($traertrailer)){
                                    ?>
                                      <iframe width="770" height="300" src="https://www.youtube.com/embed/<?php echo $rs['trailer'];?>" 
